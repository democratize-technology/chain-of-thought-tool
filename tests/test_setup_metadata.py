...
def test_setup_py_metadata():
    ...
    # Test that real values ARE present (author is Code Developer per identity-separation policy)
    assert "Code Developer" in content, "setup.py missing author name"
    assert "democratize.technology" in content, "setup.py missing real email domain"
